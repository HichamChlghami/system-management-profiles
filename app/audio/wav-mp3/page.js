...
function App() {
  ...
  const des_home = "Convert from WAV to MP3 online free, fast, secure, and in a few clicks";
  ...
  const how_des1 = "Just upload your WAV files and tap 'Convert'. Our tool guarantees the highest quality MP3 conversion.";
