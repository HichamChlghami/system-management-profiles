...
function App() {
  ...
  const des_home = "Convert JPG to PDF online with <span class='sitfile_span'>sitfile</span>—fast, secure, and entirely web-based.";
  
  const title1 = "How to Convert JPG to PDF?";
  ...
  const how_des1 = "Upload your JPG files, tap 'Convert,' and let our online service handle the rest for high-quality PDF conversion.";
  
  const title3 = "Unbeatable Features";
  const how_des2 = "Easily convert batches of JPG files to PDF—our web-based converter supports all JPG file types.";
