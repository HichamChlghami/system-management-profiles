...
<div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <p className='description'>Optimize videos with <span className='sitfile_span'>sitfile</span>—the best online compression service.</p>
...
<div className={`full_section_describe ${payer ? 'full_section_describe_noads':''}`}>
  <div className='describe_how_convert'>
    ...
    <p className='description_p'>1. Start by selecting your videos using the ‘Choose Videos’ button.</p>
    <p className='description_p'>2. Begin the compression by clicking ‘Compress.’</p>
    <p className='description_p'>3. After the compression is done, click ‘Download’ to retrieve your compressed videos.</p>
  </div>
  ...
  <div className='how_work_cards'>
    <div className='how_work_card'>
      ...
      <p className='how_work_description'>
        Just upload your videos, tap ‘Compress,’ and our online service guarantees the highest-quality video compression.
      </p>
    </div>
    ...
    <div className='how_work_card'>
      ...
      <p className='how_work_description'>
        Easily compress batches of videos. Our web-based service supports all video file formats.
      </p>
    </div>
    ...
    <div className='how_work_card'>
      ...
      <p className='how_work_description'>
        Enjoy the benefits of security with a universally compatible tool, accessible from any web browser. For added privacy, videos are automatically deleted after a few hours.
      </p>
    </div>
  </div>
